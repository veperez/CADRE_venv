# -*- mode: makefile-gmake -*-
PETSC_DIR=/home/veperez/Documents/CADRE/venv/lib/python2.7/site-packages/petsc
PETSC_ARCH=

CONFIGDIR:=$(PETSC_DIR)/$(PETSC_ARCH)/share/petsc/examples/config
...
TESTLOGFILE = $(TESTDIR)/examples-install.log
